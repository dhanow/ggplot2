---
title: "Plant Machine Utilization analysis"
knit: (function(input_file, encoding) {
  out_dir <- '../docs';
  rmarkdown::render(input_file,
 encoding=encoding,
 output_file=file.path(dirname(input_file), out_dir, 'PlantMachineUtilizationAnalysisV3.html'))})
...
# Overview
In the below exercise EDA is performed on a predictive maintenance data set to understand the utilization of plant machines. The goal is to look at the charts and find out any hidden patterns in the dataset and help ask more questions to the domain expert.
...
1. The dataset is limited in terms of the available features (only provides how the machines are utilized)
